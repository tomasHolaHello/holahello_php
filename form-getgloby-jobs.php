...
$file = "form-getgloby-jobs.csv";

if(!file_exists($file)) {
	$txt = "Name;Email;Location;Phone;Position;Portfolio;Cover letter;\r\n";
...
$txt .= str_replace(";", ",", utf8_decode($_POST['location'])).";";
$txt .= str_replace(";", ",", utf8_decode($_POST['phone'])).";";
$txt .= str_replace(";", ",", utf8_decode($_POST['position'])).";";
$txt .= str_replace(";", ",", utf8_decode($_POST['portfolio'])).";";
				...
				<tr>
					<td>
						<table>
							...
							<tr style='margin-top: 0px'>
								<td>
									<p style='color: #555555;margin: 0px 0px 0px 30px; font-size: 16px'>Location: ";
									$message .= "<span>".utf8_decode($_POST['location'])."</span>";
									$message .= "</p>
								</td>
							</tr>
							<tr style='margin-top: 0px'>
							...
							<tr style='margin-top: 0px'>
								<td>
									<p style='color: #555555;margin: 0px 0px 0px 30px; font-size: 16px'>Position: ";
									$message .= "<span>".utf8_decode($_POST['position'])."</span>";
									$message .= "</p>
								</td>
							</tr>
							<tr style='margin-top: 0px'>
								<td>
									<p style='color: #555555;margin: 0px 0px 0px 30px; font-size: 16px'>Portfolio: ";
									$message .= "<span>".utf8_decode($_POST['portfolio'])."</span>";
									$message .= "</p>
								</td>
							</tr>
							<tr style='margin-top: 0px'>
...
<table  style='align-content: center; margin: 10px auto 30px auto; width: 600px'>
	<tr>
			...
			<p style='margin: 0px'>Reply-To jobs@getgloby.com</p>
		</td>
	</tr>
	<tr>
...
// $message .= "<img src='".$domain."assets/img/lg_GetGloby-primary.png'><br/><br/>";
// $message .= "<b>Thank you for contacting us!</b><br/><br/>";
// $message .= "MESSAGE DETAILS:<br/>";
// $message .= "<b>Name:</b> ".utf8_decode($_POST['name'])."<br/>";
// $message .= "<b>Email:</b> ".utf8_decode($_POST['email'])."<br/>";
// $message .= "<b>Location:</b> ".utf8_decode($_POST['location'])."<br/>";
// $message .= "<b>Phone:</b> ".utf8_decode($_POST['phone'])."<br/>";
// $message .= "<b>Job Position:</b> ".utf8_decode($_POST['position'])."<br/>";
// $message .= "<b>Portfolio:</b> ".utf8_decode($_POST['portfolio'])."<br/>";
// $message .= "<b>Cover letter:</b> ".utf8_decode($_POST['message'])."<br/>";
// $message .= "<br/>";
// $message .= $domain;

$from = "jobs@getgloby.com";
$headers = "From:" . $from . "\r\n";
